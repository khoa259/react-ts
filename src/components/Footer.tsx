...
const Footer = (props: Props) => {
  return (
<footer className="w-screen text-center text-white mt-40" style={{backgroundColor: '#f1f1f1'}}>
  <div className="container mx-auto pt-9">
    <div className="flex justify-center mb-9">
      ...
      <a href="#!" className="mr-9 text-gray-800">
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" className="svg-inline--fa fa-twitter w-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <div className="text-center text-gray-700 p-4" style={{backgroundColor: 'rgba(0, 0, 0, 0.2)'}}>
    © 2021 Copyright:
    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> Nguyễn Hữu Khoa</a>
  </div>
</footer>
